...
export default function BasicMeeting({ children, flag, title, activityPhotos }) {
	return (
		<section class="mt-32 flex min-h-screen w-full flex-col items-center justify-center gap-5 px-3 lg:mt-10 lg:flex-row lg:justify-between">
			<div class="flex flex-col items-center justify-center gap-10 lg:ml-[10%] lg:items-start">
				<div class="flex w-full items-center justify-center gap-2 md:gap-5 lg:justify-start ">
					...
					/>
					<h2 class="font-mont text-3xl xxs:text-4xl sm:text-5xl 2xl:text-6xl">{title}</h2>
				</div>
